 ...
 *         &lt;element name="paymentMethod" type="{http://FidelyNET3_SW_01_89_00}WS_PaymentMethod" maxOccurs="unbounded"/&gt;
...
@XmlRootElement(name = "GetPaymentMethodResponse")
public class GetPaymentMethodResponse {

    protected int answerCode;
    @XmlElement(required = true)
    protected List<WSPaymentMethod> paymentMethod;
    @XmlElement(required = true)
     ...
     * {@link WSPaymentMethod }
     * 
     * 
     */
    public List<WSPaymentMethod> getPaymentMethod() {
        if (paymentMethod == null) {
            paymentMethod = new ArrayList<WSPaymentMethod>();
        }
