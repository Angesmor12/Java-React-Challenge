 ...
 *         &lt;element name="categoryList" type="{http://FidelyNET3_SW_01_89_00}WS_ExternalTransfer_Category" maxOccurs="unbounded"/&gt;
...
@XmlRootElement(name = "GetExternalTransferCategoriesResponse")
public class GetExternalTransferCategoriesResponse {

    protected int answerCode;
    @XmlElement(required = true)
    protected List<WSExternalTransferCategory> categoryList;
    @XmlElement(required = true)
     ...
     * 
     */
    public List<WSExternalTransferCategory> getCategoryList() {
        if (categoryList == null) {
            categoryList = new ArrayList<WSExternalTransferCategory>();
        }
