 ...
 *         &lt;element name="redemptionChannel" type="{http://FidelyNET3_SW_01_89_00}SW_RedemptionChannel" maxOccurs="unbounded"/&gt;
...
@XmlRootElement(name = "GetRedemptionChannelByCustomerResponse")
public class GetRedemptionChannelByCustomerResponse {

    protected int answerCode;
    @XmlElement(required = true)
    protected List<SWRedemptionChannel> redemptionChannel;
    @XmlElement(required = true)
    ...
    /**
     * Gets the value of the redemptionChannel property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the redemptionChannel property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getRedemptionChannel().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SWRedemptionChannel }
     * 
     * 
     */
    public List<SWRedemptionChannel> getRedemptionChannel() {
        if (redemptionChannel == null) {
            redemptionChannel = new ArrayList<SWRedemptionChannel>();
        }
