 ...
 *         &lt;element name="prize" type="{http://FidelyNET3_SW_01_89_00}WS_Prize" maxOccurs="unbounded"/&gt;
...
@XmlRootElement(name = "GetPrizesGiftChildsListResponse")
public class GetPrizesGiftChildsListResponse {

    protected int answerCode;
    @XmlElement(required = true)
    protected List<WSPrize> prize;
    @XmlElement(required = true)
     ...
     * 
     */
    public List<WSPrize> getPrize() {
        if (prize == null) {
            prize = new ArrayList<WSPrize>();
        }
        return this.prize;
    }
