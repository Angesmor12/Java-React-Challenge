 ...
 *         &lt;element name="discount" type="{http://FidelyNET3_SW_01_89_00}WS_DiscountExchange"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "GetDiscountExchangeResponse")
public class GetDiscountExchangeResponse {

    protected int answerCode;
    @XmlElement(required = true)
    protected WSDiscountExchange discount;
     ...
     * @return
     *     possible object is
     *     {@link WSDiscountExchange }
     *     
     */
    public WSDiscountExchange getDiscount() {
        return discount;
    }
     ...
     *     
     */
    public void setDiscount(WSDiscountExchange value) {
        this.discount = value;
    }
