 ...
 *         &lt;element name="prizes" type="{http://FidelyNET3_SW_01_89_00}WS_LittlePrize" maxOccurs="unbounded"/&gt;
...
@XmlRootElement(name = "GetWishlistResponse")
public class GetWishlistResponse {

    protected int answerCode;
    @XmlElement(required = true)
    protected List<WSLittlePrize> prizes;
    @XmlElement(required = true)
     ...
     * 
     */
    public List<WSLittlePrize> getPrizes() {
        if (prizes == null) {
            prizes = new ArrayList<WSLittlePrize>();
        }
        return this.prizes;
    }
