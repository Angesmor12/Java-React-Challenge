 ...
 *         &lt;element name="shops" type="{http://FidelyNET3_SW_01_89_00}WS_Shop" maxOccurs="unbounded"/&gt;
...
@XmlRootElement(name = "GetShopsLastMovementsResponse")
public class GetShopsLastMovementsResponse {

    protected int answerCode;
    @XmlElement(required = true)
    protected List<WSShop> shops;
    @XmlElement(required = true)
     ...
     * 
     */
    public List<WSShop> getShops() {
        if (shops == null) {
            shops = new ArrayList<WSShop>();
        }
        return this.shops;
    }
