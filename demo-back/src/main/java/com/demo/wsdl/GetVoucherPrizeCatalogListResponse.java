 ...
 *         &lt;element name="voucherList" type="{http://FidelyNET3_SW_01_89_00}WS_Voucher" maxOccurs="unbounded"/&gt;
...
@XmlRootElement(name = "GetVoucherPrizeCatalogListResponse")
public class GetVoucherPrizeCatalogListResponse {

    protected int answerCode;
    @XmlElement(required = true)
    protected List<WSVoucher> voucherList;
    @XmlElement(required = true)
     ...
     * 
     */
    public List<WSVoucher> getVoucherList() {
        if (voucherList == null) {
            voucherList = new ArrayList<WSVoucher>();
        }
