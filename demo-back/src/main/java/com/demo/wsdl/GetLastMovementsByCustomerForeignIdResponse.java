...
@XmlRootElement(name = "GetLastMovementsByCustomerForeignIdResponse")
public class GetLastMovementsByCustomerForeignIdResponse {
    ...
    public List<WSMovementWithPromotions> getMovements() {
        if (movements == null) {
            movements = new ArrayList<WSMovementWithPromotions>();
        }
