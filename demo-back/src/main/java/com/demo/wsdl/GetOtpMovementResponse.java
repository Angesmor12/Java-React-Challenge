 ...
 *         &lt;element name="movement" type="{http://FidelyNET3_SW_01_89_00}WS_Otp_Movement"/&gt;
 *         &lt;element name="exchangeablePrizes" type="{http://FidelyNET3_SW_01_89_00}WS_ExchangeablePrize" maxOccurs="unbounded"/&gt;
...
@XmlRootElement(name = "GetOtpMovementResponse")
public class GetOtpMovementResponse {

    protected int answerCode;
    @XmlElement(required = true)
    protected WSCustomer customer;
    @XmlElement(required = true)
    protected WSOtpMovement movement;
    @XmlElement(required = true)
    protected List<WSExchangeablePrize> exchangeablePrizes;
    @XmlElement(required = true)
     ...
     *     
     */
    public WSOtpMovement getMovement() {
        return movement;
    }
     ...
     *     
     */
    public void setMovement(WSOtpMovement value) {
        this.movement = value;
    }
     ...
     * This is why there is not a <CODE>set</CODE> method for the exchangeablePrizes property.
     * 
     * <p>
     ...
     * 
     */
    public List<WSExchangeablePrize> getExchangeablePrizes() {
        if (exchangeablePrizes == null) {
            exchangeablePrizes = new ArrayList<WSExchangeablePrize>();
        }
