 ...
 *         &lt;element name="discount" type="{http://FidelyNET3_SW_01_89_00}WS_Discount4Prize"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "GetDiscountExchangeGiftResponse")
public class GetDiscountExchangeGiftResponse {

    protected int answerCode;
    @XmlElement(required = true)
    protected WSDiscount4Prize discount;
     ...
     *     
     */
    public WSDiscount4Prize getDiscount() {
        return discount;
    }
     ...
     *     
     */
    public void setDiscount(WSDiscount4Prize value) {
        this.discount = value;
    }
