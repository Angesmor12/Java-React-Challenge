 ...
 *         &lt;element name="newCategoryID" type="{http://www.w3.org/2001/XMLSchema}long"/&gt;
...
@XmlRootElement(name = "ModifyCustomerCategoryRequest")
public class ModifyCustomerCategoryRequest {

    @XmlElement(required = true)
    protected String sessionID;
    protected long campaignID;
    protected long customerID;
    protected long newCategoryID;
    @XmlElement(required = true)
    ...
    /**
     * Obtiene el valor de la propiedad newCategoryID.
     * 
     */
    ...
    /**
     * Define el valor de la propiedad newCategoryID.
     * 
     */
    public void setNewCategoryID(long value) {
