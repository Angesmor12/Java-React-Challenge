 ...
 *         &lt;element name="news" type="{http://FidelyNET3_SW_01_89_00}WS_News" maxOccurs="unbounded"/&gt;
...
public class GetNewsResponse {
     ...
     * 
     */
    public List<WSNews> getNews() {
        if (news == null) {
            news = new ArrayList<WSNews>();
        }
        return this.news;
    }
