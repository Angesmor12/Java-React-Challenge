 ...
 *         &lt;element name="category" type="{http://FidelyNET3_SW_01_89_00}WS_CategoryByShop"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "ModifyCategoryResponse")
public class ModifyCategoryResponse {

    protected int answerCode;
    @XmlElement(required = true)
    protected WSCategoryByShop category;
     ...
     * @return
     *     possible object is
     *     {@link WSCategoryByShop }
     *     
     */
    public WSCategoryByShop getCategory() {
        return category;
    }
     ...
     *     
     */
    public void setCategory(WSCategoryByShop value) {
        this.category = value;
    }
