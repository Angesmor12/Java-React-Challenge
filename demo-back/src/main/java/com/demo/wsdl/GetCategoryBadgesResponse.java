 ...
 *         &lt;element name="categoryBadges" type="{http://FidelyNET3_SW_01_89_00}WS_CategoryBadge" maxOccurs="unbounded"/&gt;
...
@XmlRootElement(name = "GetCategoryBadgesResponse")
public class GetCategoryBadgesResponse {

    protected int answerCode;
    @XmlElement(required = true)
    protected List<WSCategoryBadge> categoryBadges;
    @XmlElement(required = true)
    ...
    /**
     * Gets the value of the categoryBadges property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the categoryBadges property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCategoryBadges().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<WSCategoryBadge> getCategoryBadges() {
        if (categoryBadges == null) {
            categoryBadges = new ArrayList<WSCategoryBadge>();
        }
