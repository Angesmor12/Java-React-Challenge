 ...
 *         &lt;element name="interestAreasList" type="{http://FidelyNET3_SW_01_89_00}WS_InterestArea" maxOccurs="unbounded"/&gt;
...
@XmlRootElement(name = "GetInterestAreasResponse")
public class GetInterestAreasResponse {

    protected int answerCode;
    @XmlElement(required = true)
    protected List<WSInterestArea> interestAreasList;
    @XmlElement(required = true)
    ...
    /**
     * Gets the value of the interestAreasList property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the interestAreasList property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getInterestAreasList().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<WSInterestArea> getInterestAreasList() {
        if (interestAreasList == null) {
            interestAreasList = new ArrayList<WSInterestArea>();
        }
        return this.interestAreasList;
    }
