 ...
 *         &lt;element name="catalogs" type="{http://FidelyNET3_SW_01_89_00}WS_Catalog" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "GetCatalogsByCustomerResponse")
public class GetCatalogsByCustomerResponse {

    protected int answerCode;
    @XmlElement(required = true)
    protected List<WSCatalog> catalogs;
    ...
    public List<WSCatalog> getCatalogs() {
        if (catalogs == null) {
            catalogs = new ArrayList<WSCatalog>();
        }
