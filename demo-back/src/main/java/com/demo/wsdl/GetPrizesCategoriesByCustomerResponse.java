 ...
 *         &lt;element name="categoryList" type="{http://FidelyNET3_SW_01_89_00}WS_PrizeCategory" maxOccurs="unbounded"/&gt;
...
@XmlRootElement(name = "GetPrizesCategoriesByCustomerResponse")
public class GetPrizesCategoriesByCustomerResponse {

    protected int answerCode;
    @XmlElement(required = true)
    protected List<WSPrizeCategory> categoryList;
    @XmlElement(required = true)
     ...
     * 
     */
    public List<WSPrizeCategory> getCategoryList() {
        if (categoryList == null) {
            categoryList = new ArrayList<WSPrizeCategory>();
        }
