 ...
 *         &lt;element name="category" type="{http://FidelyNET3_SW_01_89_00}WS_CategoryByShop" maxOccurs="unbounded"/&gt;
...
public class GetCategoriesResponse {
    ...
    protected List<WSCategoryByShop> category;
    @XmlElement(required = true)
     ...
     * 
     */
    public List<WSCategoryByShop> getCategory() {
        if (category == null) {
            category = new ArrayList<WSCategoryByShop>();
        }
