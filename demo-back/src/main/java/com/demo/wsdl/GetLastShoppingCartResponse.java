 ...
 *         &lt;element name="shoppingCartExchangeInfo" type="{http://FidelyNET3_SW_01_89_00}WS_ShoppingCartExchangeInfo"/&gt;
...
@XmlType(name = "", propOrder = {
    "answerCode",
    "customer",
    "shoppingCartExchangeInfo",
    "promotions"
})
@XmlRootElement(name = "GetLastShoppingCartResponse")
public class GetLastShoppingCartResponse {

    protected int answerCode;
    @XmlElement(required = true)
    protected WSCustomer customer;
    @XmlElement(required = true)
    protected WSShoppingCartExchangeInfo shoppingCartExchangeInfo;
    @XmlElement(required = true)
    ...
    /**
     * Obtiene el valor de la propiedad shoppingCartExchangeInfo.
     * 
     * @return
     *     possible object is
     *     {@link WSShoppingCartExchangeInfo }
     *     
     */
    public WSShoppingCartExchangeInfo getShoppingCartExchangeInfo() {
        return shoppingCartExchangeInfo;
    }

    /**
     * Define el valor de la propiedad shoppingCartExchangeInfo.
     * 
     * @param value
     *     allowed object is
     *     {@link WSShoppingCartExchangeInfo }
     *     
     */
    public void setShoppingCartExchangeInfo(WSShoppingCartExchangeInfo value) {
        this.shoppingCartExchangeInfo = value;
    }
