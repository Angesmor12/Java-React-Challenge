...
/**
 * <p>Clase Java para WS_ValidateVoucher complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="WS_ValidateVoucher"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="productsList" type="{http://FidelyNET3_SW_01_89_00}SW_ValidateProductVoucher" maxOccurs="unbounded"/&gt;
...
@XmlType(name = "WS_ValidateVoucher", namespace = "http://FidelyNET3_SW_01_89_00", propOrder = {
    "id",
    "voucherCode",
    "kind",
    "value",
...
public class WSValidateVoucher {
    ...
    @XmlElement(required = true)
    protected List<SWValidateProductVoucher> productsList;
     ...
     * {@link SWValidateProductVoucher }
     * 
     * 
     */
    public List<SWValidateProductVoucher> getProductsList() {
        if (productsList == null) {
            productsList = new ArrayList<SWValidateProductVoucher>();
        }
