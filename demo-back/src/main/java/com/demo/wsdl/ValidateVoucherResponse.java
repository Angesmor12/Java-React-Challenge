 ...
 *         &lt;element name="voucher" type="{http://FidelyNET3_SW_01_89_00}WS_ValidateVoucher"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class ValidateVoucherResponse {
    ...
    protected WSValidateVoucher voucher;
     ...
     * @return
     *     possible object is
     *     {@link WSValidateVoucher }
     *     
     */
    public WSValidateVoucher getVoucher() {
        return voucher;
    }
     ...
     *     
     */
    public void setVoucher(WSValidateVoucher value) {
        this.voucher = value;
    }
