 ...
 *         &lt;element name="sellers" type="{http://FidelyNET3_SW_01_89_00}WS_CustomerSeller" maxOccurs="unbounded"/&gt;
...
@XmlRootElement(name = "GetSellerListResponse")
public class GetSellerListResponse {

    protected int answerCode;
    @XmlElement(required = true)
    protected List<WSCustomerSeller> sellers;
    @XmlElement(required = true)
     ...
     * {@link WSCustomerSeller }
     * 
     * 
     */
    public List<WSCustomerSeller> getSellers() {
        if (sellers == null) {
            sellers = new ArrayList<WSCustomerSeller>();
        }
        return this.sellers;
    }
