 ...
 *         &lt;element name="news" type="{http://FidelyNET3_SW_01_89_00}WS_NewsByCustomer" maxOccurs="unbounded"/&gt;
...
@XmlRootElement(name = "GetNewsByCustomerResponse")
public class GetNewsByCustomerResponse {

    protected int answerCode;
    @XmlElement(required = true)
    protected List<WSNewsByCustomer> news;
    @XmlElement(required = true)
     ...
     * {@link WSNewsByCustomer }
     * 
     * 
     */
    public List<WSNewsByCustomer> getNews() {
        if (news == null) {
            news = new ArrayList<WSNewsByCustomer>();
        }
        return this.news;
    }
