...
/**
 * <p>Clase Java para WS_PersonalInfoStringGeolevel complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="WS_PersonalInfoStringGeolevel"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="geoLevel1" type="{http://www.w3.org/2001/XMLSchema}string"/&gt;
 *         &lt;element name="geoLevel2" type="{http://www.w3.org/2001/XMLSchema}string"/&gt;
 *         &lt;element name="geoLevel3" type="{http://www.w3.org/2001/XMLSchema}string"/&gt;
 *         &lt;element name="geoLevel4" type="{http://www.w3.org/2001/XMLSchema}string"/&gt;
 *         &lt;element name="geoLevel5" type="{http://www.w3.org/2001/XMLSchema}string"/&gt;
...
@XmlType(name = "WS_PersonalInfoStringGeolevel", namespace = "http://FidelyNET3_SW_01_89_00", propOrder = {
    "identityCard",
    "identityCardTypeId",
    "name",
    "surname",
...
public class WSPersonalInfoStringGeolevel {
    ...
    @XmlElement(required = true)
    protected String geoLevel1;
    @XmlElement(required = true)
    protected String geoLevel2;
    @XmlElement(required = true)
    protected String geoLevel3;
    @XmlElement(required = true)
    protected String geoLevel4;
    @XmlElement(required = true)
    protected String geoLevel5;
    @XmlElement(required = true)
     ...
     *     
     */
    public void setGeoLevel1(String value) {
     ...
     *     
     */
    public void setGeoLevel2(String value) {
     ...
     *     
     */
    public void setGeoLevel3(String value) {
     ...
     *     
     */
    public void setGeoLevel4(String value) {
     ...
     *     
     */
    public void setGeoLevel5(String value) {
     ...
     * This is why there is not a <CODE>set</CODE> method for the customerDynamicFields property.
     * 
     * <p>
    ...
    public List<WSCustomerDynamicField> getCustomerDynamicFields() {
        if (customerDynamicFields == null) {
            customerDynamicFields = new ArrayList<WSCustomerDynamicField>();
        }
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the interestAreas property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
    ...
    public List<WSInterestAreaCustomer> getInterestAreas() {
        if (interestAreas == null) {
            interestAreas = new ArrayList<WSInterestAreaCustomer>();
        }
