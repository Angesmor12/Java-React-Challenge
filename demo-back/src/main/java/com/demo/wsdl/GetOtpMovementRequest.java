 ...
 *         &lt;element name="otpCode" type="{http://www.w3.org/2001/XMLSchema}integer"/&gt;
...
@XmlRootElement(name = "GetOtpMovementRequest")
public class GetOtpMovementRequest {

    @XmlElement(required = true)
    protected String sessionID;
    @XmlElement(required = true)
    protected BigInteger otpCode;
     ...
     *     
     */
    public void setOtpCode(BigInteger value) {
        this.otpCode = value;
    }
