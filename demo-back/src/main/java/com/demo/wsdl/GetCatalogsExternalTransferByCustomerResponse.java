 ...
 *         &lt;element name="catalogs" type="{http://FidelyNET3_SW_01_89_00}WS_CatalogExternalTransfer" maxOccurs="unbounded"/&gt;
...
@XmlRootElement(name = "GetCatalogsExternalTransferByCustomerResponse")
public class GetCatalogsExternalTransferByCustomerResponse {

    protected int answerCode;
    @XmlElement(required = true)
    protected List<WSCatalogExternalTransfer> catalogs;
    @XmlElement(required = true)
     ...
     * 
     */
    public List<WSCatalogExternalTransfer> getCatalogs() {
        if (catalogs == null) {
            catalogs = new ArrayList<WSCatalogExternalTransfer>();
        }
