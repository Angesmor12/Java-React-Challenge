 ...
 *         &lt;element name="crmID" type="{http://www.w3.org/2001/XMLSchema}long" maxOccurs="unbounded"/&gt;
...
@XmlRootElement(name = "GetCrmsByCustomerRequest")
public class GetCrmsByCustomerRequest {
     ...
     * This is why there is not a <CODE>set</CODE> method for the crmID property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCrmID().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Long> getCrmID() {
        if (crmID == null) {
            crmID = new ArrayList<Long>();
        }
        return this.crmID;
    }
