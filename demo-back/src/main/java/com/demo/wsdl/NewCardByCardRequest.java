 ...
 *         &lt;element name="customer" type="{http://FidelyNET3_SW_01_89_00}WS_CustomerBaseCard"/&gt;
...
@XmlRootElement(name = "NewCardByCardRequest")
public class NewCardByCardRequest {

    @XmlElement(required = true)
    protected String sessionID;
    @XmlElement(required = true)
    protected WSCustomerBaseCard customer;
    @XmlElement(required = true)
     ...
     * @return
     *     possible object is
     *     {@link WSCustomerBaseCard }
     *     
     */
    public WSCustomerBaseCard getCustomer() {
        return customer;
    }
     ...
     *     
     */
    public void setCustomer(WSCustomerBaseCard value) {
        this.customer = value;
    }
