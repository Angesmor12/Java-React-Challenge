 ...
 *         &lt;element name="customer" type="{http://FidelyNET3_SW_01_89_00}WS_Customer" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "GetCustomersByDNIResponse")
public class GetCustomersByDNIResponse {

    protected int answerCode;
    @XmlElement(required = true)
    protected List<WSCustomer> customer;
    ...
    public List<WSCustomer> getCustomer() {
        if (customer == null) {
            customer = new ArrayList<WSCustomer>();
        }
