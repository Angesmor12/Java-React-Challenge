 ...
 *         &lt;element name="categoriesNews" type="{http://FidelyNET3_SW_01_89_00}WS_NewsCategory" maxOccurs="unbounded"/&gt;
...
@XmlRootElement(name = "GetNewsCategoriesResponse")
public class GetNewsCategoriesResponse {

    protected int answerCode;
    @XmlElement(required = true)
    protected List<WSNewsCategory> categoriesNews;
    @XmlElement(required = true)
    ...
    /**
     * Gets the value of the categoriesNews property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the categoriesNews property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCategoriesNews().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<WSNewsCategory> getCategoriesNews() {
        if (categoriesNews == null) {
            categoriesNews = new ArrayList<WSNewsCategory>();
        }
        return this.categoriesNews;
    }
