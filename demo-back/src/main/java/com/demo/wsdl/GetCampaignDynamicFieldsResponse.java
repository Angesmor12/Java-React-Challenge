 ...
 *         &lt;element name="dynamicFields" type="{http://FidelyNET3_SW_01_89_00}WS_DynamicField" maxOccurs="unbounded"/&gt;
...
@XmlRootElement(name = "GetCampaignDynamicFieldsResponse")
public class GetCampaignDynamicFieldsResponse {

    protected int answerCode;
    @XmlElement(required = true)
    protected List<WSDynamicField> dynamicFields;
    @XmlElement(required = true)
     ...
     * 
     */
    public List<WSDynamicField> getDynamicFields() {
        if (dynamicFields == null) {
            dynamicFields = new ArrayList<WSDynamicField>();
        }
