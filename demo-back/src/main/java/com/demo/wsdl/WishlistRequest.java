 ...
 *         &lt;element name="prizes" type="{http://FidelyNET3_SW_01_89_00}WS_PrizeWishlist" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class WishlistRequest {
    ...
    @XmlElement(required = true)
    protected List<WSPrizeWishlist> prizes;
     ...
     * {@link WSPrizeWishlist }
     * 
     * 
     */
    public List<WSPrizeWishlist> getPrizes() {
        if (prizes == null) {
            prizes = new ArrayList<WSPrizeWishlist>();
        }
        return this.prizes;
    }
