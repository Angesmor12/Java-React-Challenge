 ...
 *         &lt;element name="foilList" type="{http://FidelyNET3_SW_01_89_00}WS_FoilList" maxOccurs="unbounded"/&gt;
...
@XmlRootElement(name = "SearchGiftCardByFoilResponse")
public class SearchGiftCardByFoilResponse {

    protected int answerCode;
    @XmlElement(required = true)
    protected List<WSFoilList> foilList;
    @XmlElement(required = true)
    ...
    /**
     * Gets the value of the foilList property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the foilList property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getFoilList().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<WSFoilList> getFoilList() {
        if (foilList == null) {
            foilList = new ArrayList<WSFoilList>();
        }
        return this.foilList;
    }
