 ...
 *         &lt;element name="productList" type="{http://FidelyNET3_SW_01_89_00}WS_ProductDetail" maxOccurs="unbounded"/&gt;
...
public class GetProductsResponse {
    ...
    protected List<WSProductDetail> productList;
    @XmlElement(required = true)
     ...
     * {@link WSProductDetail }
     * 
     * 
     */
    public List<WSProductDetail> getProductList() {
        if (productList == null) {
            productList = new ArrayList<WSProductDetail>();
        }
